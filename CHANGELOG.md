...
- Give `staging` branch builds an inverted aqua/black application icon while retaining the production bundle identity and credential stores — local staging builds are visually distinct without breaking production Matrix sessions or saved credentials.
