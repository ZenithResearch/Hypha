...
- Pin MSC4143, MSC4140, MSC4195, MSC4196, MSC4075, MSC4310, and MSC4519 heads, source paths, SHA-256 digests, exhaustive stable/unstable event/capability/API identifiers, state-key rules, required capabilities, and explicit exclusions.
...
- [ ] All seven proposal heads, paths, statuses, content digests, and canonical manifest fingerprint are exact.
