...
final class MatrixSynapseAdminClientTests: XCTestCase {
    func testAdministratorErrorDispositionClassifiesPrimarySessionExpiryAndAllOtherFailures() {
        ...
        XCTAssertEqual(MatrixAdministratorErrorDisposition.classify(MatrixAdminClientError.invalidInput), .invalidInput)
        XCTAssertEqual(MatrixAdministratorErrorDisposition.classify(MatrixAdminClientError.protectedAccount), .protectedAccount)
        XCTAssertEqual(
            MatrixAdministratorErrorDisposition.classify(MatrixAdminClientError.credentialNotEstablished),
            .credentialNotEstablished
        )
