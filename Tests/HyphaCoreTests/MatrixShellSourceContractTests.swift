...
final class MatrixShellSourceContractTests: XCTestCase {
    ...
    func testAdministratorControlsAreAuthorityGatedAndPresentedAsASheet() throws {
        ...
        for marker in [
            ...
            "matrix.admin.accounts.search",
            "Search all users by Matrix ID",
            "matrix.admin.rooms.scope",
            "matrix.admin.rooms.search",
            "All public rooms and their owners",
            "room.ownerUserID",
    ...
    func testNativeShellContainsRequiredSafeStatesAndAccessibilityIdentifiers() throws {
        ...
        let requiredMarkers = [
            ...
            "Check and connect",
            "Private Tailscale homeserver",
            "Connect through Tailscale",
            "Open Tailscale",
            "tailscale://",
            "https://tailscale.com/download",
            "matrix.homeserver.tailscale.connect",
            "matrix.homeserver.tailscale.open",
            "connect this device to the authorized tailnet",
